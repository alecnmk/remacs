...
<% else -%>
<% end -%>")) 0)
    ("%lt" "" (lambda nil (interactive) (snippet-insert "<%= label_tag(:$${param}, \"$${text}\") %>")) 0)
    ("%st" "" (lambda nil (interactive) (snippet-insert "<%= submit_tag(\"$${text}\") %>")) 0)
    ("%t" "" (lambda nil (interactive) (snippet-insert "<%=t '.$${@item}' %>")) 0)
    ("%tft" "" (lambda nil (interactive) (snippet-insert "<%= text_field_tag(:$${param}) %>")) 0)
...
$.
<%= end_form_tag %>")) 0)
    ("ftm" "" (lambda nil (interactive) (snippet-insert "<% form_tag ($${path}_path, :method => :$${method}) do %>
$.
<% end %>")) 0)
